...
const ROUTES: Route[] = [
  ...
  { path: "/docs/execution", priority: 0.8, changeFrequency: "monthly" },
  { path: "/docs/provers", priority: 0.8, changeFrequency: "monthly" },
  { path: "/docs/tools", priority: 0.8, changeFrequency: "monthly" },
  { path: "/docs/data-availability", priority: 0.8, changeFrequency: "monthly" },
  { path: "/docs/security", priority: 0.8, changeFrequency: "monthly" },
  { path: "/docs/governance", priority: 0.7, changeFrequency: "monthly" },
