...
const DOCS_COLLECTION = [
  ...
  { name: "Execution Model", path: "/docs/execution", description: "Three-stage queue / prove / resume — how an agent call runs across blocks." },
  { name: "Provers", path: "/docs/provers", description: "Off-chain compute that runs every model call. Full TensorCommitment proofs and lite signature attestation." },
  { name: "Tools & Enclave", path: "/docs/tools", description: "On-chain tools, off-chain tools via the blessed enclave, and the credential model." },
  { name: "Data Availability", path: "/docs/data-availability", description: "TheseusStore. Content-addressed roots anchor heavy data; the chain verifies without storing it." },
  { name: "Security", path: "/docs/security", description: "Trust assumptions at alpha, prover accountability, DoS defense, KZG verification cost model." },
  { name: "Governance", path: "/docs/governance", description: "Forkless runtime upgrades, validator voting with delegation, scope at alpha." },
  ...
  { name: "Agentic Smart Contracts", path: "/docs/agentic-smart-contracts", description: "Why agents are the next evolution of smart contracts, and the design space they open." },
