  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <article className="px-4 pt-28 pb-24 sm:px-6 lg:pt-36">
        ...
        {post.canonical && (
          <footer className="mx-auto mt-20 max-w-2xl border-t border-slate-200 pt-6 text-[13px] text-slate-500 dark:border-slate-800 dark:text-slate-400">
            Originally published on{" "}
            <a
              href={post.canonical}
              target="_blank"
              rel="noopener noreferrer canonical"
              className="underline decoration-slate-300 underline-offset-4 hover:text-indigo-700 hover:decoration-indigo-500 dark:decoration-slate-600 dark:hover:text-indigo-300"
            >
              Substack
            </a>
            .
