...
export default function BuildIDE() {
  ...
  return (
    <div className="flex h-[560px] flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg dark:border-slate-700/60 dark:bg-[#060b16] dark:shadow-2xl lg:h-auto lg:aspect-[16/10]">
      <div className="flex flex-shrink-0 items-center gap-3 border-b border-slate-200 bg-slate-100 px-4 py-2 dark:border-slate-800/60 dark:bg-[#0F172A]">
        ...
        <div className="ml-2 truncate rounded border border-slate-200 bg-white px-3 py-0.5 font-mono text-[11px] text-slate-500 dark:border-slate-800/60 dark:bg-[#060b16] dark:text-slate-400">
          {selected}
        </div>
      </div>
